...
func NewRouter(kdb *KDB, token string) *mux.Router {
	...
	var routes = Routes{
		...
		Route{"GetAttachment", "GET", "/{db}/{docid:[A-Za-z0-9][A-Za-z0-9_]*}/{attname}", kdbHandler.GetAttachment},
		Route{"HeadAttachment", "HEAD", "/{db}/{docid:[A-Za-z0-9][A-Za-z0-9_]*}/{attname}", kdbHandler.HeadAttachment},
		Route{"PutAttachment", "PUT", "/{db}/{docid:[A-Za-z0-9][A-Za-z0-9_]*}/{attname}", kdbHandler.PutAttachment},
		Route{"DeleteAttachment", "DELETE", "/{db}/{docid:[A-Za-z0-9][A-Za-z0-9_]*}/{attname}", kdbHandler.DeleteAttachment},
